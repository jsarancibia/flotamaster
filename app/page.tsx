  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <motion.nav 
        ...
        animate={{ y: 0 }}
        transition={{ duration: 0.6, ease: "easeOut" }}
        className="fixed top-0 left-0 right-0 z-50 glass dark:glass-dark border-b border-white/20 dark:border-gray-800/60"
      >
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-accent-light dark:from-gray-950 dark:via-gray-900 dark:to-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div 
            ...
            className="absolute top-20 right-0 w-[600px] h-[600px] bg-primary rounded-full blur-3xl dark:opacity-20"
          />
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.1 }}
            transition={{ duration: 1, delay: 0.3 }}
            className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-primary-400 rounded-full blur-3xl dark:opacity-20"
          />
          {/* Grid Pattern */}
          <div className="absolute inset-0 bg-[linear-gradient(rgba(13,71,161,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(13,71,161,0.03)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:50px_50px]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-32 relative z-10">
          ...
          >
            <div>
              ...
              <motion.h1 
                variants={fadeInUp}
                className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight mb-6"
              >
                Control y seguimiento de{' '}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 dark:from-blue-400 dark:via-sky-400 dark:to-indigo-400">
                  tu flota
                </span>{' '}
                en un solo lugar
              </motion.h1>
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-4">
                ...
                <a 
                  href="#modulos"
                  className="inline-flex items-center gap-2 bg-white dark:bg-gray-900 text-primary dark:text-primary-300 px-8 py-4 rounded-2xl font-semibold border-2 border-primary/20 dark:border-primary/30 hover:border-primary transition-all cursor-pointer"
                >
                  Ver módulos
                </a>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8 mt-12 pt-8 border-t border-gray-200">
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Resumen operativo</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Vehículos y conductores</p>
                </div>
                <div className="hidden sm:block w-px h-12 bg-gray-200 dark:bg-gray-800" />
                <div>
                  <p className="font-heading text-3xl font-bold text-primary">Control</p>
                  <p className="text-gray-500 dark:text-gray-400">Mantenimientos y estado</p>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div 
              ...
              className="relative"
            >
              <div className="relative z-10 bg-white dark:bg-gray-900 rounded-3xl shadow-2xl shadow-primary/20 p-8 border border-white/50 dark:border-gray-800">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
                  ...
                  <div className="bg-gradient-to-br from-accent-light to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border border-primary/10 dark:border-gray-800">
                    <Users className="w-8 h-8 text-primary dark:text-primary-300 mb-3" />
                    <p className="text-2xl font-bold text-primary dark:text-primary-300">Colectivos</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Flota completa</p>
                  </div>
                </div>
                <div className="mt-4 grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={i} className={`${item.color} dark:bg-gray-800 dark:text-gray-200 rounded-xl p-4 text-center`}>
        ...
        {/* Wave Divider - curva que termina suave en la esquina sin corte vertical */}
        <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full min-w-full h-20 text-white dark:text-gray-950" preserveAspectRatio="none">
            <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 85C1200 90 1320 90 1380 90C1410 90 1440 105 1440 120H0Z" fill="currentColor"/>
          </svg>
        </div>
      </section>

      {/* Services Section */}
      <section id="modulos" className="py-24 bg-white dark:bg-gray-950">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="group bg-white dark:bg-gray-900 rounded-3xl p-8 border border-gray-100 dark:border-gray-800 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300"
              >
                ...
                <h3 className="font-heading text-xl font-bold text-gray-900 dark:text-white mb-3">{service.title}</h3>
      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white dark:bg-gray-950 rounded-3xl p-12 shadow-2xl shadow-primary/10 border border-primary/10 dark:border-gray-800"
          >
      ...
      {/* Contact Section */}
      <section id="soporte" className="py-24 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
